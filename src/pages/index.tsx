        ...
        <>
            ...
            <main>
                <section className="first-section">
                    ...
                    <div className="second-col">
                        <Image className="image" src={MainImage} alt="Man having a video conference" style={{height: "auto"}} />
                ...
                <section className="third-section">
                    <div className="first-col">
                        <Image src={People} alt="People" className="image" style={{height: "auto"}} />
                    </div>
                    <div className="second-col">
            ...
            <footer>
                <div>
                    ...
                    <div className="icons">
                        <div className="icon"><Image src={Instagram} alt="Instagram" /></div>
                        <div className="icon"><Image src={Dribbble} alt="Dribbble" /></div>
                        <div className="icon"><Image src={Twitter} alt="Twitter" /></div>
                        <div className="icon"><Image src={Youtube} alt="Youtube" /></div>
                    </div>
                </div>
                <div>
                    <h4 className="subtitle">Company</h4>
                    <Link className='text' href="/#">Home</Link><br />
                    <Link className='text' href="/#">Blogs</Link><br />
                    <Link className='text' href="/#">About</Link><br />
                    <Link className='text' href="/#">Carreers</Link><br />
                </div>
                <div>
                    <h4 className="subtitle">Legal</h4>
                    <Link className='text' href="/#">Terms & Conditions</Link><br />
                    <Link className='text' href="/#">Privacy Policy</Link><br />
                </div>
                <div>
                ...
                <div className='bottom'>
                    ...
                    <div className='links'>
                        <Link className='text' href="/#">Terms & Conditions</Link>
                        <Link className='text' href="/#">Privacy Policy</Link>
                        <Link className='text' href="/#">Sitemap</Link>
                        <Link className='text' href="/#">Disclaimer</Link>
                    </div>
                </div>
            </footer>
        </>
