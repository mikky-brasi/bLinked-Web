...
export default function AgentActionModal({ show, setShow, action, selected }: AgentActionModalProps) {
    const [content, setContent] = useState<{title?: string;subtitle?: string;text?: string;image?: string;button?: string;buttonStyle?: CSSProperties}>({});
                ...
                <Modal.Body className="body">
                    <form className="form">
                        ...
                        <div className="image-container">
                            <div className="bg">
                                <Image src={image ? `data:image/png;base64,${image}` : Memoji} alt="Emoji placeholder" className="img" />
                                <input
                                    className="hidden"
