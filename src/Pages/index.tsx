      ...
      <main>
        <section className="first-section">
          ...
          <div className="second-col">
            ...
            <p className="text">
              ...
              businesses to service providers to ensure accessibility to and of
        ...
        <section className="third-section">
          ...
          <div className="second-col">
            ...
            <p className="text">
              A framework of large networked connections with different
              organization having huge existing customer base and also diversity
              with respect to range of services.
            </p>
            <ul className="list">
              <li className="list-item">Constantly improving</li>
              <li className="list-item">
                Built-in services you need for business
              </li>
